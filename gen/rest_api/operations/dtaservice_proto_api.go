...
func NewDtaserviceProtoAPI(spec *loads.Document) *DtaserviceProtoAPI {
	return &DtaserviceProtoAPI{
		...
		DtaServerOptionsHandler: d_t_a_server.OptionsHandlerFunc(func(params d_t_a_server.OptionsParams) middleware.Responder {
...
type DtaserviceProtoAPI struct {
	...
	// DtaServerOptionsHandler sets the operation handler for the options operation
	DtaServerOptionsHandler d_t_a_server.OptionsHandler
