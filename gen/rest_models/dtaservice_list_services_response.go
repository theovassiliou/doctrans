...
// ContextValidate validates this dtaservice list services response based on context it is used
func (m *DtaserviceListServicesResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
