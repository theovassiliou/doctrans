...
type TransformDocumentParams struct {
	...
	/*Body*/
	Body *models.DtaserviceDocumentRequest
...
func (o *TransformDocumentParams) WithBody(body *models.DtaserviceDocumentRequest) *TransformDocumentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the transform document params
func (o *TransformDocumentParams) SetBody(body *models.DtaserviceDocumentRequest) {
	o.Body = body
}
