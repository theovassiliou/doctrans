...
type ListServicesOK struct {
	Payload *models.DtaserviceListServicesResponse
}
...
func (o *ListServicesOK) GetPayload() *models.DtaserviceListServicesResponse {
	return o.Payload
}
...
func (o *ListServicesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DtaserviceListServicesResponse)
